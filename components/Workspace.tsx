...
import type { AbuseDashboard, Backend, Invite, Pricing, UsageLimits, Viewer, WaitlistEntry } from "../lib/backend";
...
export function LiveWorkspace({ viewer }: { viewer: Viewer }) {
  ...
  useEffect(() => { if (ideas && pricing && usageLimits) backend.push({ ideas, pricing, usageLimits, invites: invites || [], waitlist: waitlist || [], abuse, viewer }); }, [backend, ideas, pricing, usageLimits, invites, waitlist, abuse, viewer]);
