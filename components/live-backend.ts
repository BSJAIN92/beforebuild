...
export function createLiveBackend(client: ConvexReactClient, viewer: Viewer, signOut: () => Promise<void>): LiveBackend {
  let data: Snapshot = { ideas: [], viewer, invites: [], waitlist: [], support: [], pricing: { enabled: false, currency: "USD", intermediate: 0, advanced: 0 }, usageLimits: { basicTurns: 10, intermediateTurns: 15, intermediateResearch: 1, advancedTurns: 22, advancedResearch: 1 } };
