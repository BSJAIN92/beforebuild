...
with sync_playwright() as p:
    ...
    check('Sidebar name opens the profile editor', page.locator('dialog[open] #profile-form').count() == 1)
    page.locator('#profile-name').fill('Alex Rivera')
    page.locator('#profile-form button[type="submit"]').click()
    check('Saved profile name updates the sidebar', 'Alex Rivera' in page.locator('.profile-details').inner_text())
